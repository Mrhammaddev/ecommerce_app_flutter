...
final PersistentTabController bottomTabController = PersistentTabController(
  initialIndex: 0,
);
...
class LandingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<Widget> _buildScreens() {
      return [HomeView(), CartView(), AlertView(), ProfileView()];
    }
    ...
    return PersistentTabView(
      ...
      decoration: NavBarDecoration(
        // boxShadow: [
        //   BoxShadow(color: Colors.black.withOpacity(0.2), blurRadius: 8.0),
        // ],
